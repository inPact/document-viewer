...
window.DocumentViewer.EnrichOrderTranslateService = (function () {

    function EnrichOrderTranslateService(options) {
        _configure(options)
    }
    ...
    EnrichOrderTranslateService.prototype.getText = _getText;

    return EnrichOrderTranslateService;
